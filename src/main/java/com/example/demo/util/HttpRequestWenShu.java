...
import com.example.demo.testutil.KuaiShouActiveResult;
...
public class HttpRequestWenShu {

    private static Logger LOGGER = LoggerFactory.getLogger(HttpRequestWenShu.class);
    ...
    public static String post(String url, String param) {
        // 创建默认的httpClient实例
        CloseableHttpClient httpClient = HttpRequestWenShu.getHttpClient();
        CloseableHttpResponse httpResponse = null;
        // 发送post请求
        try {

            String testJSON = "{\"id\":\"25cdb7aaf0515a \",\"os_type\":1,\"did_md5\":\"1ac6f6554c4a2a899f6ed4acad700c7c\"}";
    ...
    public static void main(String[] args) {
        ...
        //post("https://zhuan.58.com/activity/rta.kuaishou", "?id=111111&did_md5=1ac6f6554c4a2a899f6ed4acad700c7c");
        //post("http://10.9.31.83:8025/activity/rta.kuaishou", "?id=111111&did_md5=d7d6004690f6f6044b0ec16d34c92d98");
      /*  String testJSON = "{\"id\":\"25cdb7aaf0515a \",\"os_type\":1,\"did_md5\":\"0f4e4715b415a794082644e92f72779b\"}";
        ...
        long nanoTime = localDateTime.toInstant(ZoneOffset.of("+8")).toEpochMilli();

        Long millTime = localDateTime.toInstant(ZoneOffset.of("Asia/Shanghai")).toEpochMilli();
